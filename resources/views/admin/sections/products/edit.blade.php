            ...
            <div class="col-xl-8">
                <div class="panel">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" id="productStock" type="number" min="0" name="total_stock" value="{{ old('total_stock', $product->total_stock ?? '') }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel mt-4">
                    <div class="panel-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="hasSpecificationCheck" name="has_specifications" value="1" {{ old('has_specifications', $product->has_specifications) == 1 ? 'checked' : '' }}>
                            ...
                            @foreach ($product->specifications as $item)
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="specificationOptionInput" name="specification_options[]" value="{{ old('specification_options[]', $item->key) }}" placeholder="Model, Material, Warranty, etc.">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="specificationValueSelect">Value*</label>
                                        <input class="form-control" id="specificationValueSelect" name="specification_values[]" value="{{ old('specification_values[]', $item->value) }}" placeholder="Enter values">
                                    </div>
                                </div>
                            @endforeach
                        </div>
