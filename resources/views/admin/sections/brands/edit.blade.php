...
<div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <div class="col-12 col-xl-7">
        <form class="panel needs-validation" novalidate method="POST" action="{{ route('admin.brands.update', $brand->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <input class="form-control" id="formName" name="name" value="{{ $brand->name }}" required>
                </div>
                <div class="col-12">
                    <label class="form-label" for="formMessage">Description</label>
                    <textarea class="form-control" id="formMessage" name="description" rows="5">{{ $brand->description }}</textarea>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input class="form-control" id="formName" name="meta_title" value="{{ $brand->meta_title }}">
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="formPlan">Meta Description</label>
                    <textarea class="form-control" id="formPlan" name="meta_description" rows="3">{{ $brand->meta_description }}</textarea>
                </div>
                <div class="col-md-6">
                    <label class="form-label" for="formStatus">Status</label>
                    <input type="hidden" name="status" value="0">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="formStatus" name="status" value="1" {{ $brand->status ? 'checked' : '' }}>
